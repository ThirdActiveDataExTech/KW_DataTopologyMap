package kware.apps.system.user.domain;

import cetus.bean.Page;
import cetus.bean.Pageable;
import cetus.dao.SuperDao;
import kware.apps.system.user.dto.request.UserExcelSearch;
import kware.apps.system.user.dto.request.UserListSearch;
