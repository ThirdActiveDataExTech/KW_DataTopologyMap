...
public class DatasetRestController {
    ...
    **/
    ...
    public ResponseEntity<PackageImportResponse> savPackageDataset(
                                                @RequestPart("request") SavePackageDataset request,
                                                @RequestPart("packageFileData") MultipartFile packageFileData ) throws IOException {
        if(packageFileData.isEmpty()) {
            return ResponseEntity.badRequest().body(null);
        }
        PackageImportResponse packageDataset = service.savePackageDataset(request, packageFileData);
        return ResponseEntity.ok().body(packageDataset);
    }
    ...
    public ResponseEntity<Page<MetadataList>> pageMetadata(SearchMetadataPage search) {
    ...
    public ResponseEntity metadataPreview(@RequestParam("file") MultipartFile file) throws IOException {
        ...
        return ResponseEntity.ok(apiResponse.getResult());
    }
